...
const FEATURED: FeaturedPokemonType[] = [
  {
    id: 1,
    name: "Bulbasaur",
    type: "Grama",
    ...
    <section className="py-20 container-main">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {FEATURED.map((poke) => (
          <div
            key={poke.id}
            className="group relative bg-card border rounded-3xl p-6 hover:shadow-xl transition-all hover:-translate-y-2"
          >
            <div
              className={`absolute inset-0 ${poke.color} opacity-20 rounded-3xl -z-10`}
            />
